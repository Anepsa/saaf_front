 ...
 const ProveedoresRow = props => {
  ...
  const getUser = () => {
    // Get Individual user API Call Data 
      ...
      const {estado,  _id ,clave , nombre , email , telefono , rfc , company , empresa, fecha } = props
  ...
  return (
    <tr className="userRow">
      ...
      {/* <td>{clave}</td> */}
      <td>
        <Link to={`/proveedor/edit/${company}/${empresa}/${_id}`}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProveedoresRow);
